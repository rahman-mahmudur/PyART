...
def get_rec_point(file):
	...
	for line in lines:
		...
		#print(len(apis))
		#print(test_data)
		clf=joblib.load('traincsv/'+CURRENT_PROJ+'_NaiveBayes.pkl')
...
print("Top K Averages for Naive Bayes: Top 1: " + str(topk_array[0]) + " Top 2: " + str(topk_array[1]) + " Top 3: " + str(topk_array[2]) + " Top 4: " + str(topk_array[3]) + " Top 5: " + str(topk_array[4]) + " Top 10: " + str(topk_array[5]) + " MRR: " + str(topk_array[6]))
